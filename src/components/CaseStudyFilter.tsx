                ...
                {categories.map((category) => (
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs font-medium transition-all duration-300 ${activeCategory === category
                            ...
                            : "text-gray-400 hover:text-gray-400 border border-transparent hover:border-white/[0.06]"
                            }`}
                    >
                        {category}
                    </button>
                        ...
                        >
                            ...
                            <div className="p-7">
                                <div className="flex items-center gap-2 mb-3">
                                    <span className="text-[9px] uppercase tracking-[0.2em] text-gray-400 font-semibold px-2 py-0.5 rounded-full border border-white/[0.05]">
                                        {study.category}
                                    </span>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                    {study.tags.map((tag) => (
                                        <span
                                            key={tag}
                                            className="text-[10px] text-gray-400 px-2 py-0.5 rounded-full border border-white/[0.04] bg-white/[0.01]"
                                        >
                                            {tag}
                                        </span>
                                    ))}
