...
const processSteps = [
    ...
    {
        icon: <ShieldAlert className="w-6 h-6 text-[#FF5A1F]" />,
    ...
    {
        icon: <Rocket className="w-6 h-6 text-[#0047FF]" />,
        ...
        <div className="bg-[#0A0A0F] min-h-screen">
            ...
            <section className="relative pt-40 pb-24 border-b border-[#1C1C24] overflow-hidden">
                <div className="max-w-[1280px] w-full mx-auto px-6 relative z-10 text-center">
                    ...
                    <motion.h1 
                        ...
                        className="text-h1 text-[#F5F6FA] mb-8 max-w-4xl mx-auto tracking-tight"
                    >
                    ...
                    <motion.p 
                        ...
                        className="text-body-lg max-w-2xl mx-auto mb-4"
                    >
            ...
            <section className="py-24 bg-[#111116] border-b border-[#1C1C24] relative">
                 <div className="max-w-[800px] mx-auto px-6 relative z-10">
                     <div className="absolute top-0 bottom-0 left-[41px] md:left-[51px] w-[1px] bg-[#1C1C24] z-0 hidden sm:block" />
                     
                     <div className="flex flex-col gap-16 relative z-10">
                          {processSteps.map((step, i) => (
                              <div key={i} className="flex flex-col sm:flex-row gap-6 md:gap-10 items-start">
                                  <div className="w-14 h-14 shrink-0 bg-[#0A0A0F] border border-[#1C1C24] rounded-full flex items-center justify-center shadow-[0_0_0_8px_#111116] z-10">
                                      {step.icon}
                                  </div>
                                  <div className="pt-2 z-10">
                                      <div className="text-[11px] font-mono uppercase tracking-wider font-bold text-[#FF5A1F] mb-2">{step.timeline}</div>
                                      <h3 className="text-xl font-bold font-space text-[#F5F6FA] mb-4">{step.title}</h3>
                                      <p className="text-sm text-[#A3A3B3] leading-relaxed">{step.desc}</p>
                                  </div>
                              </div>
                          ))}
                     </div>
            ...
            {/* ── WHAT WE NEVER DO ─────────────────────── */}
            <section className="py-24 bg-[#0A0A0F] border-b border-[#1C1C24] relative">
                <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                    <div>
                        <span className="text-[11px] font-mono text-[#0047FF] uppercase tracking-wider block mb-3">{"//"} CODE OF CONDUCT</span>
                        <h2 className="text-h2 text-[#F5F6FA] tracking-tight mb-8">
                            A strict adherence to engineering integrity.
                        </h2>
                        <p className="text-body max-w-lg mb-8">
                            Trust in the automation industry is notoriously low. We offset that by enforcing a rigid operational code of conduct. These are our non-negotiables.
                        </p>
                    </div>
                    
                    <div className="bg-[#111116] border border-[#1C1C24] p-8 md:p-10 rounded-[6px]">
                        <ul className="space-y-6">
                            {neverDoList.map((item, i) => (
                                <li key={i} className="flex gap-4 items-start pb-6 border-b border-[#1C1C24] last:border-b-0 last:pb-0">
                                    <div className="text-[#FF5A1F] font-bold">✕</div>
                                    <div className="text-[#E5E5E5] text-sm leading-relaxed">{item}</div>
                                </li>
                            ))}
                        </ul>
                    </div>
            ...
            {/* ── CTA ──────────────────────────────────── */}
            <section className="py-32 flex justify-center px-6 bg-[#111116]">
